...
const DesignPreview = ({configuration}: {configuration: Configuration}) => {
    ...
    useEffect(() => 
        setShowConfetti(true) , [showConfetti , setShowConfetti])
    ...
    let totlPrice = BASE_PRICE
    if(material ==='polycarbonate') totlPrice += PRODUCT_PRICES.material.polycarbonate
    if(finish ===  'textured')  totlPrice +=  PRODUCT_PRICES.finish.textured
    ...
    <div className='mt-20 flex flex-col items-center md:grid  text-sm  sm:grid-cols-12 sm:grid-rows-1 sm:gap-x-6 md:gap-x-8 lg:gap-x-12'>
        ...
        <div className='mt-6 sm:col-span-9 md:row-end-1'> 
            <h3 className='text-3xl font-bold tracking-tight text-gray-900'>
                Your {modelLabel} Case</h3> <div className='mt-3 flex items-center gap-1.5 '>
                ...
                <div>
                     <p className='font-medium text-zinc-950'>Highlights</p>
                      <ol className='mt-3 text-zinc-700 list-disc list-inside'> 
                        ...
                        <li>5 Year print warranty</li> </ol> 
                        </div>
                        <div>
